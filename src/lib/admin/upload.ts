 ...
 * айфонные оригиналы по 3–7 МБ сайту не нужны. Большое фото до сервера
 * доходит уже уменьшенным браузером (лимит запроса Vercel — 4,5 МБ, см.
 * lib/admin/photo-file); здесь всё равно пережимаем: браузеру не доверяем.
 */
