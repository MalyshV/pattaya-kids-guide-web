...
export const th: Dictionary = {
  ...
  memory: {
    menuAria: "อยากไปและเคยไปแล้ว",
    navSaved: "อยากไป",
    navVisited: "เคยไปแล้ว",
    pageTitle: "อยากไป · เคยไปแล้ว",
    pageIntro:
      "สถานที่ คลาสเรียน และอีเวนต์ที่คุณอยากไปหรือเคยไปมาแล้ว รายการเก็บอยู่ในเบราว์เซอร์นี้เท่านั้น — ไม่ต้องสมัครสมาชิก",
    backToCatalog: "← ไปหน้าสถานที่",
    emptyCta: "ดูสถานที่",
    saveLabel: "อยากไป",
    savedLabel: "นำออกจาก “อยากไป”",
    visitLabel: "เคยไปแล้ว",
    visitedLabel: "นำออกจาก “เคยไปแล้ว”",
    savedSection: "อยากไป",
    visitedSection: "เคยไปแล้ว",
    savedSectionEmpty: "ยังว่างอยู่ — กด ♡ บนการ์ดสถานที่ คลาสเรียน และอีเวนต์ที่อยากไป",
    visitedSectionEmpty:
      "ยังว่างอยู่ — กด ✓ ที่ที่เคยไปมาแล้ว: สถานที่ คลาสเรียน อีเวนต์",
    emptyTitle: "ยังว่างอยู่",
    emptyHint: "กด ♡ ที่ที่อยากไป และกด ✓ ที่ที่เคยไปแล้ว ทุกอย่างจะมารวมอยู่ที่นี่",
    remove: "นำออก",
