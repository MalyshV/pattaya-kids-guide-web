...
export const en: Dictionary = {
  ...
  memory: {
    menuAria: "Want to go and been there",
    navSaved: "Want to go",
    navVisited: "Been there",
    pageTitle: "Want to go · Been there",
    pageIntro:
      "Places, activities and events you want to go to or have already been to. The list is kept in this browser only — no sign-up.",
    backToCatalog: "← To places",
    emptyCta: "Browse places",
    saveLabel: "Want to go",
    savedLabel: "Remove from “Want to go”",
    visitLabel: "Been there",
    visitedLabel: "Remove from “Been there”",
    savedSection: "Want to go",
    visitedSection: "Been there",
    savedSectionEmpty:
      "Nothing yet — tap ♡ on places, activities and events you want to go to.",
    visitedSectionEmpty:
      "Nothing yet — tap ✓ where you've already been: places, activities, events.",
    emptyTitle: "Nothing here yet",
    emptyHint:
      "Tap ♡ where you want to go and ✓ where you've already been. Everything shows up here.",
    remove: "Remove",
