...
export const ru = {
  ...
  // Одно имя от кнопки до страницы (решение Вероники 21.09): ♡ «Хотим
  // сходить» — план, ✓ «Уже были» — память; «Избранного» больше нет.
  memory: {
    // в шапке — один вход ♡✓ с меню: обе функции и счётчики видны до перехода
    menuAria: "Хотим сходить и уже были",
    navSaved: "Хотим сходить",
    navVisited: "Уже были",
    pageTitle: "Хотим сходить · Уже были",
    pageIntro:
      "Места, занятия и события, куда хотите сходить и где уже были. Список хранится только в этом браузере — без регистрации.",
    ...
    saveLabel: "Хотим сходить",
    savedLabel: "Убрать из «Хотим сходить»",
    visitLabel: "Уже были",
    visitedLabel: "Убрать из «Уже были»",
    savedSection: "Хотим сходить",
    visitedSection: "Уже были",
    savedSectionEmpty:
      "Пока пусто — нажимайте ♡ на карточках мест, занятий и событий, куда хотите сходить.",
    visitedSectionEmpty:
      "Пока пусто — отмечайте ✓ там, где уже были: места, занятия, события.",
    emptyTitle: "Пока пусто",
    emptyHint:
      "Нажимайте ♡ там, куда хотите сходить, и ✓ там, где уже были. Всё появится здесь.",
    remove: "Убрать",
