  ...
  await prisma.placeProgram.createMany({
    data: [
      ...
      },
      {
        ...
        description:
          "Клубная программа с преимуществами: −30% на игровую, −15% на мероприятия и мастер-классы, −10% в кафе, −15% на услуги няни, приоритетный доступ и приглашения на эксклюзивные мастер-классы. Стоимость и условия вступления уточняются.",
